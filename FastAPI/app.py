...
#API da série Rick and Morty: https://rickandmortyapi.com/documentation/#rest
'''Utilizaremos apenas o endpoint de pesonagens
O objetivo deste exercício é adicionar novas funcionalidades ao projeto
Você deverá adicionar uma página para listar as localizações e os episódios,
além de melhorar a página de perfil do personagem.
'''
